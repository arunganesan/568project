...
parser.add_argument('--savefilter', type=str, default='runs/config7.txt', help="Saves the filter state to be used in matlab")
...
try:
    while True:
        ...
        for zm in measurements:
            ...
            for n in index:
                newParticles.append(copy.deepcopy(particles[n]))
